      ...
      //  processRequest(request, response);
        PrintWriter out = response.getWriter();
            ...
            int result = 0;
             ...
             if(request.getParameter("vsubjectid")!=null){
             subjectId=request.getParameter("vsubjectid");
             }
             if(request.getParameter("vsubjectname")!=null){
             subjectName=request.getParameter("vsubjectname");
             }       
             if(request.getParameter("vsubjectmarks")!=null){
             subjectMarks=request.getParameter("vsubjectmarks");
             }       
            
try{
    con = DbConnect.getConnection();
    
    PreparedStatement ps = con.prepareStatement("insert into subjects(subjectid,subjectname,totalmarks) values(?,?,?)");
...
if(result > 0){
           out.println("<html><head><script>alert('Subject has been added')");
