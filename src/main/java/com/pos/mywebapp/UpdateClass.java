    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            ...
            String pclassid=new String();
             ...
             if(request.getParameter("edclassname")!=null){
             className=request.getParameter("edclassname");
             }            
try{
    con = DbConnect.getConnection();
    
    PreparedStatement ps = con.prepareStatement("update masterclass set classid=?,classname=? where classid=?");
...
if(result > 0){
           out.println("<html><head><script>alert('Class Updated...')");
