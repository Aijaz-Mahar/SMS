    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      PrintWriter out = response.getWriter();
            ...
            int result = 0;
             ...
             if(request.getParameter("vdeptid")!=null){
             deptId=request.getParameter("vdeptid");
             }
             if(request.getParameter("vdeptname")!=null){
             deptName=request.getParameter("vdeptname");
             }            
try{
    con = DbConnect.getConnection();
    
    PreparedStatement ps = con.prepareStatement("insert into department(deptid,deptname) values(?,?)");
...
if(result > 0){
           ...
           out.println("<html><head><script>alert('Department has been added')");
