...
.topnav a.active {
  ...
  <a href="AttendanceSheet.jsp">Class Attendance Report</a>
        ...
        %>
    <center>
         <p style="color:white;background-color: green; width:280px; font-size: 20px;">Attendance Entry</p>
         <%--
         <form action=""> 
         --%>
                <table border="1">
                  <tr>
                      <td>
                      Date:<br>
                      <input type="date" id="attendancedate" name="attendancedate" required><!-- comment -->
                      </td>
                   <td>
         ...
         <% } %>
               ...
               <td>
           Section:<br>
           <select  style="font-size:15px;" name="section" id="section" onchange="showStudents()"></div>                
             <%  
...
*/
 ...
 const vdate=document.getElementById("attendancedate").value;

  const xhttp = new XMLHttpRequest();
  xhttp.onload = function() {
    document.getElementById("txtHint").innerHTML = this.responseText;
  }
  xhttp.open("GET", "StudentsForAttendance.jsp?sessionid="+vsessionid+"&classid="+vclassid+"&sectionid="+vsection+"&attendancedate="+vdate);
  xhttp.send();
}
