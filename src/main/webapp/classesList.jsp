...
.btnsave {
    ...
    <body>
<div class="topnav">
  <a class="active" href="classesList.jsp">Classes</a>
  ...
  <a href="\reports\PrintClassList.jsp" target="_blank">Print List</a>
        ...
        <%
         ...
         conn=DbConnect.getConnection();
               Statement statement = conn.createStatement();
                 String sql = "SELECT classid,classname FROM masterclass order by classid ";
    ...
    <br><br><br>
        <TABLE id="courseTable" cellpadding="10" border="1" style="background-color: cornflowerblue;color: white" align="center">
            ...
            <th style="color: black;background-color: aliceblue">Class Name</th>
...
String cn;
          while (result.next()) {
            ...
            <TR>
                ...
                <TD class="tclassname"><%=result.getString("classname")%></TD>
                 <td>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            --%>
                            <p class="modal-title"> Adding Class</p>
                        </div>
                        <div class="modal-body">
                            <p>
                            <form name="catform" id="catform1" class="catform" method="post" action="AddClass">
                               Class ID:<br>
                                <input type="text" id="vclassid" name="vclassid" size="40">
                                <br>
                                Class Name:<br>
                                <input type="text" id="vclassname" name="vclassname" size="40">
                                </p>
    ...
    <div class="modal fade" id="editModal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                    <form name="catform" id="catform1" class="catform" method="post" action="UpdateClass">
                        Class ID:<br>
                        <input type="text" id="edclassid" name="edclassid" size="40">
                        <br>
                        Class Name:<br>
                        <input type="text" id="edclassname" name="edclassname" size="40" >   
                        </p>
...
<script>
    ...
    function toggleModal(element) {
       ...
       const cname = tableRowElement.getElementsByClassName('tclassname')[0].innerHTML;
      const pcid=tableRowElement.getElementsByClassName('tclassid')[0].innerHTML;
      document.getElementById('edclassid').value = cid;
       document.getElementById('edclassname').value = cname;
