    ...
    <body>
        ...
        String sid,cid;
              ...
              //   String sql = "SELECT admissionformno,sessionyear,admissionclass,grno,rollnumber,fullname,studentpic FROM addmissionForm  where sessionyear='"+sid+"' and admissionclass='"+cid+"'";
                ...
                + "s.sessionyear as sessionyear,s.remarks as remarks from student s,addmissionform a where a.grno=s.grno order by s.classid,s.sessionyear desc";
  ...
  int row=1;
          while (result.next()) {
            ...
            <tr>
                ...
                <td>  <img src="DisplayStdPic.jsp?admid=<%=result.getString("grno")%>" alt="Pic" width="50" height="50" >
                </td>
                <%--
                 <td>       
