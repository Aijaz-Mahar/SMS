...
.topnav a.active {
  ...
  <a href="#>Print List"></a>
        ...
        %>
    <center>
         <p style="color:white;background-color: green; width:280px; font-size: 20px;">Assign Subjects to Class</p>
         <%--
         <form action=""> 
         --%>
            ...
            Select Class:
            <select  style="font-size:15px;" name="classes" onchange="showClasses(this.value)"></div>
...
function showClasses(str) {
  ...
  xhttp.open("GET", "SelectSubjectsforClass.jsp?sid="+str);
  xhttp.send();
}
