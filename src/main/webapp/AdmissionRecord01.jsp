  ...
  <thead>
      <tr>
           ...
           <th scope="col" style="color: black;background-color: aliceblue; height: 20px;">Full Name</th>
            ...
            <th scope="col"  style="color: black;background-color: aliceblue; text-align: center;height: 20px;"> <button type="button" class="btn btn-info btn-lg" id="myBtn" style="width:60px;padding: 5px 0px; height: 35px; background-color: #31b131;font-size: 16px;">       
                    Add</button></th>
            <th scope="col"  style="color: black;background-color: aliceblue; text-align: center;height: 20px;"> <button type="button" class="btn btn-print btn-lg" id="printBtn" style="width:70px;padding: 5px 0px; height: 35px; background-color: #31b131;font-size: 16px;"
                                                                                                                         onclick="printStudents()">       
                    Print List</button></th>
            ...
            <script>
                function studentFunction() {
                  ...
                  function sessionFunction() {
                    ...
                    sessionfilter = input.value.toUpperCase();
                    table = document.getElementById("catTable");
                    tr = table.getElementsByTagName("tr");
                    ...
                    for (i = 0; i < tr.length; i++) {
                        ...
                        if (td) {
                            txtValue = td.textContent || td.innerText;
                            if (txtValue.toUpperCase()===sessionfilter) {
                                tr[i].style.display = "";
                            } else {
                                tr[i].style.display = "none";
                            }
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    --%>
                    <p class="modal-title"> Admission Form Data</p>
                </div>
...
//document.write(sid+"  "+cid);
 ...
 var new_window = window.open("PrintAdmissionList.jsp?sessionid="+vsessionid+"&classid="+vclassid,'_blank');
new_window.document.write(xhr.responseText);
    //document.getElementById("stdinfo").innerHTML = this.responseText;
  };
 
  xhttp.open("GET", "PrintAdmissionList.jsp?sessionid="+vsessionid+"&classid="+vclassid);
  xhttp.send();
}
