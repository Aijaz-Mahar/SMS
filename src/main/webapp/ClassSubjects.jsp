...
<body>
 ...
 String sql = "SELECT cs.classid,s.subjectid as subjectid,subjectname,cs.totalmarks as totalmarks FROM classsubjects cs,subjects s where cs.subjectid=s.subjectid "
                 + "and cs.classid='"+cid+"' ";
    ...
    <center>
        ...
        --%>
        <br>
    <form id="chkform" name="chkform" method="post" action="RemoveClassSubjects.jsp">
        <TABLE id="courseTable" cellpadding="10" border="1" style="background-color: white;color: black" align="center">
            ...
            <th style="color: black;background-color: aliceblue">Remove </th>
...
String cn;
          while (result.next()) {
            ...
            <TR>
                ...
                <TD><%=result.getString("totalmarks")%></TD>
