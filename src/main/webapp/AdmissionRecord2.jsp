 ...
 a:hover {
  ...
  text-decoration: underline;
        ...
        <%
         ...
         out.println(sid+" "+cid);
              ...
              //   String sql = "SELECT admissionformno,sessionyear,admissionclass,grno,rollnumber,fullname,studentpic FROM addmissionForm  where sessionyear='"+sid+"' and admissionclass='"+cid+"'";
                ...
                + "siblingid,categoryid,anydisability,anyallergy,studentpic FROM addmissionForm where sessionyear='"+sid+"' and admissionclass='"+cid+"'";   
    ...
    <center>
          ...
          <p style="color:white;background-color: #333; width:500px; height: 30px; font-size: 20px;">
            Select Session:
            <select  style="font-size:15px;" name="sessions" id="sessions" onchange="sessionFunction()"> 
             <%  
  ...
  <select  style="font-size:15px;" name="classes" id="classes" onchange="classFunction()"> 
    ...
    <div class="container">
        ...
        <TABLE id="stdTable" cellpadding="10" border="1" style="background-color: white;color: black" align="center">
  <thead>
      <tr>
           <th scope="col" style="color: black;background-color: aliceblue;height:30px;">S.No</th>
           <th scope="col" style="color: black;background-color: aliceblue;height:30px;">Form#</th>
           <th scope="col" style="color: black;background-color: aliceblue; height: 30px;">Full Name</th>
            ...
            <th scope="col" style="color: black;background-color: aliceblue; height: 30px;">GR# </th>
            ...
            <th scope="col" colspan="2" style="color: black;background-color: aliceblue; text-align: center;"> <button type="button" class="btn btn-info btn-lg" id="myBtn" style="width:60px;padding: 5px 0px; height: 40px; background-color: #31b131;font-size: 16px;">       
                    Add</button></th>
  ...
  int row=1;
          while (result.next()) {
            ...
            <tr>
                ...
                <td>  <img src="DisplayStdPic.jsp?admid=<%=result.getString("admissionformno")%>" alt="Pic" width="50" height="50" >
                </td>
                <%--
                 <td>       
                ...
                <td>
                    <% String r=result.getString("admissionformno");             
                    %>
                    
                     <a href="#" onclick="toggleModal(this,'<%=r%>')">Quick View</a>
                </td><!-- comment -->
                <td>
                      <% String formno=result.getString("admissionformno");             
                    %>
...
// alert('jj');
      ...
      var imgloc='DisplayStdPic.jsp?admid='+admissionid;
